const CACHE_NAME = "find-my-tube-v200";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./about.html",
  ...
  "./assets/css/style.css?v=20260505b",
  "./assets/js/script.js?v=20260505b",
  "./assets/js/find-my-test.js?v=20260425a",
  "./assets/data/data.js?v=20260505a",
  "./assets/data/find-my-test-map.json?v=20260427a",
  "./assets/data/find-my-test-dictionary.json?v=20260427a",
  "./favicon.svg",
  "./favicon-16.png",
  "./favicon-32.png",
